    ...
    rsx! {
        ...
        div {
            ...
            div { class: "h-full overflow-y-auto",
                div { class: "sticky top-0 z-10 bg-background/95 backdrop-blur-sm border-b border-border",
                    div { class: "px-4 py-3 flex items-center justify-between",
                        ...
                        div { class: "flex items-center gap-2",
                            ...
                            if is_owner {
                                ...
                                button {
                                    class: if *delete_task_id.read() > 0 { "p-2 rounded-lg text-red-500/50 cursor-not-allowed" } else { "p-2 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/20 text-red-500 transition" },
                        ...
                        div { class: "text-center py-12 text-muted-foreground",
                            ...
                            if is_owner {
                                p { class: "text-sm mt-2",
                                    "Add items from recipes, notes, communities, and more!"
                                }
                            }
                        }
                    } else {
        ...
        if *show_delete_confirm.read() {
            if let Some(ref err) = *delete_error.read() {
                div { class: "fixed inset-x-0 top-20 z-[51] flex justify-center pointer-events-none",
                    div { class: "bg-red-500/95 text-white px-4 py-2 rounded-lg shadow-lg max-w-md text-center",
                        "{err}"
                    }
                }
            }
            ConfirmModal {
                ...
                message: "Are you sure you want to delete this board? This action cannot be undone. Note: Existing pins will become orphaned."
                    .to_string(),
