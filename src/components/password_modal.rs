                ...
                div { class: "mt-6 space-y-4",
                    ...
                    if is_migration {
                        ...
                        div { class: "text-xs space-y-1",
                            div { class: if password.read().len() >= 8 { "text-green-600 dark:text-green-400" } else { "text-muted-foreground" },
                                "• At least 8 characters"
                            }
                            div { class: if passwords_match && !password.read().is_empty() { "text-green-600 dark:text-green-400" } else { "text-muted-foreground" },
                                "• Passwords match"
                            }
                        }
