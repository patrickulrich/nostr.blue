...
pub fn MarkdownEditor(mut props: MarkdownEditorProps) -> Element {
    ...
    // Handle format request from toolbar
    let handle_format = {
    ...
    rsx! {
        div {
            class: "flex flex-col h-full border border-border rounded-lg overflow-hidden",
            ...
            // Mode selector tabs
            div {
                class: "flex border-b border-border bg-muted/20",
                button {
            ...
            div {
                class: "px-4 py-2 text-xs text-muted-foreground bg-muted/30 border-t border-border flex items-center justify-between",
                ...
                div {
                    ...
                    span {
                        ...
                        kbd { class: "px-1.5 py-0.5 bg-muted rounded text-[10px] font-mono", "Ctrl+B" }
                        span { "Bold" }
                    }

                    span {
                        class: "hidden sm:inline-flex items-center gap-1",
                        kbd { class: "px-1.5 py-0.5 bg-muted rounded text-[10px] font-mono", "Ctrl+I" }
                        span { "Italic" }
                    }

                    span {
                        class: "hidden md:inline-flex items-center gap-1",
                        kbd { class: "px-1.5 py-0.5 bg-muted rounded text-[10px] font-mono", "Ctrl+K" }
                        span { "Link" }
                    }
                }
            }
