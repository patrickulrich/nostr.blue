        ...
        div {
            ...
            div {
                                ...
                                div { class: "flex flex-col py-2 border-b border-border last:border-0",
                                    div { class: "flex justify-between items-center text-sm",
                                        ...
                                        span { class: "font-mono",
                                            "{result.proofs_before} → {result.proofs_after}"
                                        }
                                    }
                            ...
                            div { class: "space-y-2 text-sm",
                                for (mint , count) in mint_proof_counts.iter() {
                                    div { class: "flex justify-between",
                                        ...
                                        span { class: if *count > 8 { "font-mono text-orange-500" } else { "font-mono text-green-500" },
                                            "{count} proofs"
                                        }
                                    }
                                }
                ...
                div { class: "px-6 py-4 border-t border-border flex gap-3",
                    ...
                    if !*is_complete.read() {
                        button {
                            class: if *is_optimizing.read() || total_proofs <= 8 { "flex-1 px-4 py-3 bg-purple-500 text-white font-semibold rounded-lg transition opacity-50 cursor-not-allowed" } else { "flex-1 px-4 py-3 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded-lg transition" },
