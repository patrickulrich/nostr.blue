                ...
                Ok(info) => {
                    ...
                    match cashu::validate_nutzap_recipient_with_info(&info) {
                        ...
                        Err(e) => {
                            ...
                            // Still show the info, just no compatible mint
                        }
                    }
            ...
            div {
                ...
                div {
                    ...
                    if let Some(info) = recipient_info.read().as_ref() {
                        div {
                            ...
                            div {
                                ...
                                div {
                                    ...
                                    span { class: "font-mono text-xs", {truncate_pubkey(&recipient_pubkey)} }
                                }
                                div {
                                    class: "flex justify-between",
                        ...
                        // Target event info (if nutzapping specific content)
                        if target_event_id.is_some() {
                            div {
                                class: "text-xs text-muted-foreground bg-accent/30 rounded px-3 py-2",
                ...
                div {
                    ...
                    }
                    {
                        let is_disabled = *is_sending.read()
                            || *is_loading_info.read()
                            || load_error.read().is_some()
                            || compatible_mint.read().is_none()
