...
pub fn CashuReceiveModal(on_close: EventHandler<()>) -> Element {
    ...
    let mut verify_dleq = use_signal(|| false);
        ...
        div {
            ...
            div {
                ...
                div { class: "p-6 space-y-4",
                    ...
                    div { class: "flex items-start gap-3 p-3 bg-accent/30 rounded-lg",
                        input {
                            r#type: "checkbox",
                            id: "verify-dleq",
                ...
                div { class: "px-6 py-4 border-t border-border flex gap-3",
                    ...
                    button {
                        class: if *is_receiving.read() || token_string.read().is_empty() { "flex-1 px-4 py-3 bg-blue-500 text-white font-semibold rounded-lg transition opacity-50 cursor-not-allowed" } else { "flex-1 px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition" },
