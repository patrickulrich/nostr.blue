...
pub fn ImageUploadDialog(props: ImageUploadDialogProps) -> Element {
    ...
    // Track upload progress from global store
            ...
            div {
                ...
                ModalBody {
                    div {
                        ...
                        // Upload area / Preview
                        div {
                            class: "border-2 border-dashed border-border rounded-lg overflow-hidden bg-muted/30",
                        ...
                        if has_image {
                            div {
                                class: "p-3 rounded-lg bg-muted/50 border border-border",
                                ...
                                code {
                                    class: "text-xs font-mono break-all text-foreground",
                                    {
                                        ImageInsertData {
                                            url: uploaded_url.read().clone(),
                                            alt: alt_text.read().clone(),
