...
pub fn PublishConfirmDialog(props: PublishConfirmDialogProps) -> Element {
    ...
    rsx! {
        DialogRoot {
            ...
            DialogContent {
                div { class: "w-full max-w-2xl max-h-[80vh] flex flex-col",
                    div { class: "flex items-center justify-between p-4 border-b border-border",
                        DialogTitle {
                            h2 { class: "text-xl font-bold", "Publish Article" }
                        }
                        button {
                        ...
                        div { class: "flex-1 overflow-y-auto p-4",
                            div { class: "border border-border rounded-lg overflow-hidden bg-card",
                                ...
                                div { class: "p-4 space-y-3",
                                    h3 { class: "text-lg font-bold line-clamp-2", "{props.title}" }
                            ...
                            div { class: "mt-6 p-4 border border-border rounded-lg bg-muted/30",
                                label { class: "flex items-start gap-3 cursor-pointer",
                                    ...
                                    div { class: "flex-1",
                                        span { class: "font-medium text-sm", "Share to your feed" }
