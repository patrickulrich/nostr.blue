    ...
    rsx! {
        div {
            ...
            div {
                ...
                // Title
                h3 {
                    class: "font-semibold text-lg text-foreground line-clamp-2 pr-8",
                    "{page.article.title}"
                }
                ...
                // Wikilinks (forward links)
                if !page.forward_links.is_empty() {
                    div {
                        class: "flex flex-wrap gap-1",
                        for link in page.forward_links.iter().take(5) {
                            span {
                                class: "inline-flex items-center px-2 py-0.5 text-xs bg-accent rounded-md",
                ...
                div {
                    ...
                    div {
                        ...
                        if let Some(ref picture) = author_picture {
                            ...
                            div {
                                class: "w-5 h-5 rounded-full bg-gradient-to-br from-primary/50 to-accent/50 flex items-center justify-center text-xs font-medium text-primary-foreground",
...
pub fn WikiCardSearchResult(
    ...
    rsx! {
        div {
            ...
            // Preview with optional highlighting
            p {
                ...
                div {
                    ...
                    dd {
                        ...
                        if let Some(ref picture) = author_picture {
                            ...
                            div {
                                class: "w-4 h-4 rounded-full bg-gradient-to-br from-primary/50 to-accent/50 flex items-center justify-center text-xs font-medium text-primary-foreground",
                                "{author_name.chars().next().unwrap_or('?').to_uppercase()}"
                            }
                        }
                        span { "{author_name}" }
