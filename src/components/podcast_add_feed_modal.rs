            ...
            div {
                ...
                div { class: "p-4 border-b border-border",
                    div { class: "flex items-center justify-between",
                        h2 { class: "text-lg font-bold", id: "modal-title", "Add Podcast Feed" }
                        button {
                ...
                div { class: "p-4 space-y-4",
                    div {
                        label { class: "block text-sm font-medium mb-1.5", "RSS Feed URL" }
                        ...
                        div { class: "border border-border rounded-lg overflow-hidden",
                            div { class: "flex gap-3 p-3",
                                ...
                                div { class: "flex-1 min-w-0",
                                    h3 { class: "font-semibold truncate", "{podcast.title}" }
                                    ...
                                    if podcast.has_v4v {
                                        div { class: "mt-1",
                                            span { class: "px-1.5 py-0.5 text-xs font-medium bg-amber-500/20 text-amber-500 rounded",
                                                "V4V"
                                            }
                                        }
                                    }
