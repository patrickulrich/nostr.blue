        ...
        div {
            ...
            div {
                ...
                div { class: "mb-4 text-sm text-gray-600 dark:text-gray-400",
                    p { class: "mb-2",
                        "Paste your Nostr Wallet Connect URI to enable lightning payments."
                    }
                    p { class: "mb-2",
                ...
                if let Some(error) = connection_error() {
                    div { class: "mb-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200
                        ...
                        p { class: "text-sm text-red-800 dark:text-red-200", "{error}" }
                    }
                }
                if connection_success() {
                    div { class: "mb-4 p-3 bg-green-50 dark:bg-green-900/30 border border-green-200
