        ...
        div {
            ...
            div {
                ...
                form { onsubmit: handle_submit, class: "p-4 space-y-4",
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-1.5", "Description" }
                        textarea {
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-1.5", "Cover Image" }
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-1.5", "Additional Tags" }
                        div { class: "flex items-center gap-2 mb-1.5",
                            ...
                            span { class: "text-xs text-muted-foreground", "(always included)" }
                        }
                        input {
                            class: "w-full px-3 py-2 border border-border rounded-lg bg-background focus:outline-hidden focus:ring-2 focus:ring-primary text-sm",
                            r#type: "text",
