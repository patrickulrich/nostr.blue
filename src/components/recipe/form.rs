        ...
        form {
            ...
            div {
                    ...
                    div { class: "grid grid-cols-2 md:grid-cols-3 gap-3 mb-3",
                        for (idx , url) in image_urls.read().iter().enumerate() {
                            div {
                                ...
                                if idx == 0 {
                                    span { class: "absolute top-2 left-2 px-2 py-0.5 bg-primary text-primary-foreground text-xs rounded",
                                        "Cover"
                                    }
                                }
                            }
                ...
                if *show_image_uploader.read() {
                    ...
                    button {
                        r#type: "button",
                        class: if image_urls.read().is_empty() { "w-full aspect-video rounded-lg border-2 border-dashed border-border hover:border-primary hover:bg-primary/5 transition flex flex-col items-center justify-center gap-2 text-muted-foreground hover:text-primary" } else { "w-full py-3 rounded-lg border-2 border-dashed border-border hover:border-primary hover:bg-primary/5 transition flex items-center justify-center gap-2 text-muted-foreground hover:text-primary" },
            ...
            div { class: "grid grid-cols-3 gap-4",
                div {
                    label { class: "block text-sm font-medium mb-2", "Prep Time" }
                    input {
                        r#type: "text",
                ...
                div {
                    label { class: "block text-sm font-medium mb-2", "Cook Time" }
                    input {
                        r#type: "text",
                        class: "w-full px-3 py-2 rounded-lg border border-border bg-background focus:outline-hidden focus:ring-2 focus:ring-primary text-sm",
                ...
                div {
                    label { class: "block text-sm font-medium mb-2", "Servings" }
                    input {
                        r#type: "text",
                        class: "w-full px-3 py-2 rounded-lg border border-border bg-background focus:outline-hidden focus:ring-2 focus:ring-primary text-sm",
                        placeholder: "e.g., 4",
