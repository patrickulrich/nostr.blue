        ...
        div { class: "max-w-4xl mx-auto",
            ...
            div { class: "mb-6",
                ...
                if let Some(ref sum) = summary {
                    p { class: "text-lg text-muted-foreground mb-4", "{sum}" }
                }
                div { class: "flex items-center gap-3",
                    Link {
                        to: Route::RecipeChef {
                            npub: author_pubkey_for_link.clone(),
                        },
                        ...
                        div {
                            ...
                            span { class: "text-sm text-muted-foreground ml-2", "{created_at_str}" }
                        }
                    }
                }
            ...
            if has_details {
                div { class: "grid grid-cols-3 gap-4 p-4 bg-muted/50 rounded-lg mb-6",
            ...
            div { class: "flex items-center justify-between mb-6 p-3 bg-card border border-border rounded-lg",
                span { class: "text-sm font-medium", "Cooking Mode" }
                button {
                    r#type: "button",
                    class: format!(
            ...
            if let Some(ref notes) = chef_notes {
                div { class: "mb-8",
                    ...
                    div { class: "prose prose-neutral dark:prose-invert max-w-none p-4 bg-muted/30 rounded-lg",
                        p { "{notes}" }
                    }
                }
            }
...
pub fn RecipeDetailViewSkeleton() -> Element {
    rsx! {
        div { class: "max-w-4xl mx-auto animate-pulse",
            div { class: "w-full aspect-video rounded-xl bg-muted mb-6" }
            div { class: "mb-6",
