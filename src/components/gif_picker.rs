                    ...
                    div {
                        ...
                        div { class: "flex-1 min-h-0 overflow-y-auto",
                            if !recent_gifs.data().read().is_empty() && search_query.read().is_empty() {
                                div { class: "p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-750 dark:to-gray-800",
                                    h4 { class: "text-xs font-bold text-gray-600 dark:text-gray-300 uppercase tracking-wide mb-3 flex items-center gap-2",
                                        span { "⏱️" }
                                        "Recent"
                                    }
                            ...
                            div { class: "p-4",
                                if *gif_loading && gif_results.data().read().is_empty() {
                                    div { class: "flex flex-col items-center justify-center py-16 text-gray-500 dark:text-gray-400",
                                        div { class: "animate-spin rounded-full h-12 w-12 border-4 border-blue-500 border-t-transparent mb-4" }
                                        p { class: "text-base font-medium", "Loading GIFs..." }
                                ...
                                if !*gif_loading && gif_results.data().read().is_empty() {
                                    div { class: "flex flex-col items-center justify-center py-16 text-gray-500 dark:text-gray-400",
                                        ...
                                        p { class: "text-base font-medium", "No GIFs found" }
                                        p { class: "text-xs mt-2 text-gray-400 text-center max-w-xs",
                                        ...
                                        for (idx , gif) in gif_results.data().read().iter().enumerate() {
                                            {
                                                ...
                                                rsx! {
                                                    button {
                                                        ...
                                                        div { class: "absolute inset-0 bg-blue-500/0 group-hover:bg-blue-500/20 transition-all duration-200 pointer-events-none" }
                                                    }
                                                }
                                            }
                                        }
