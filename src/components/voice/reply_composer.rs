        ...
        div {
            ...
            div {
                ...
                div { class: "flex items-center justify-between p-4 border-b border-border",
                    h3 { class: "text-lg font-bold", "Voice Reply" }
                    button {
                ...
                div { class: "p-4 bg-gray-50 dark:bg-gray-900 border-b border-border",
                    ...
                    div { class: "text-sm text-gray-700 dark:text-gray-300 line-clamp-3 overflow-hidden",
                        if reply_content.starts_with("http")
                            && (reply_content.contains(".mp4") || reply_content.contains(".webm")
                                || reply_content.contains(".ogg"))
                        {
