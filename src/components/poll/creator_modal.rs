        ...
        div {
            ...
            div {
                ...
                div { class: "flex items-center justify-between p-4 border-b border-border",
                    h2 { class: "text-xl font-bold flex items-center gap-2", "📊 Create Poll" }
                    button {
                ...
                div { class: "p-4 space-y-4 max-h-[60vh] overflow-y-auto",
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-2", "Question" }
                        textarea {
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-2", "Options" }
                        PollOptionList { options, on_change: handle_options_change }
                    }
                    div {
                        ...
                        div { class: "flex gap-2 flex-wrap",
                            for preset in ["1hour", "1day", "1week"] {
                                button {
                                    key: "{preset}",
                                    class: if *end_time_preset.read() == preset { "px-3 py-1.5 rounded-lg border-2 border-primary bg-primary/10 text-primary text-sm font-medium" } else { "px-3 py-1.5 rounded-lg border border-border hover:border-primary transition text-sm" },
                            ...
                            if *show_advanced.read() {
                                button {
                                    class: if *end_time_preset.read() == "custom" { "px-3 py-1.5 rounded-lg border-2 border-primary bg-primary/10 text-primary text-sm font-medium" } else { "px-3 py-1.5 rounded-lg border border-border hover:border-primary transition text-sm" },
                    ...
                    if *show_advanced.read() {
                        div { class: "space-y-4 pt-2 border-t border-border",
                            div {
                                label { class: "block text-sm font-medium mb-2", "Poll Type" }
                                div { class: "flex gap-4",
                                    label { class: "flex items-center gap-2 cursor-pointer",
                                        ...
                                        span { class: "text-sm", "Single Choice" }
                                    }
                                    label { class: "flex items-center gap-2 cursor-pointer",
                                        input {
                                            r#type: "radio",
                                        ...
                                        span { class: "text-sm", "Multiple Choice" }
                                    }
                                }
                            }
                            div {
                                label { class: "block text-sm font-medium mb-2", "Additional Hashtags" }
                                input {
                                    r#type: "text",
