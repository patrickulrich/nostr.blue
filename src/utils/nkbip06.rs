...
// ============================================================================
// Constants for Nostr MIME Categories
// ============================================================================
...
// ============================================================================
// MIME Type Generation for Known Kinds
// ============================================================================
...
pub fn mime_type_for_kind(kind: u16) -> NostrMimeType {
    match kind {
        ...
        // Default: text/plain with unknown use case
        _ => {
...
pub fn parse_nostr_mime(m_value: &str) -> Option<NostrMimeType> {
    ...
    Some(NostrMimeType {
        standard: String::new(), // Not available from M tag alone
