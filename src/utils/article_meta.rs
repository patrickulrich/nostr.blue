...
mod tests {
    ...
    fn test_calculate_read_time() {
        assert_eq!(calculate_read_time(""), 1);
        assert_eq!(calculate_read_time(&"word ".repeat(200)), 1);
        assert_eq!(calculate_read_time(&"word ".repeat(400)), 2);
        assert_eq!(calculate_read_time(&"word ".repeat(250)), 2);
    }
    #[test]
