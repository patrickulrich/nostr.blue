...
enum DetectedInputType {
    Unknown,
    Url(String),
    EventId(String),        // nevent or note
    Address(String),        // naddr
    Isbn(String),           // isbn:
    Podcast(String),        // podcast:guid:
...
impl DetectedInputType {
    fn detect(input: &str) -> Self {
        ...
        // Check for NIP-73 external identifiers
        ...
        // Try to parse as bare event ID (64 hex chars)
    ...
    fn to_pin_reference(&self) -> Option<PinReference> {
        match self {
            ...
            Self::Address(addr) => {
                // Parse naddr to coordinate format
...
pub fn PinNew() -> Element {
    ...
    // Custom image (uploaded or manual URL)
    ...
    // Other boards (collaborative boards not owned by user)
    ...
    let handle_submit = move |evt: dioxus::events::FormEvent| {
        ...
        // Combine owned boards + other boards
            ...
            if !*nostr_client::CLIENT_INITIALIZED.read() {
                ...
                div {
                    ...
                    form {
                        ...
                        // Reference input with Fetch button
                        div {
                            label {
                        ...
                        // Preview card (after successful fetch)
                        if fetch_succeeded {
                            div {
                                ...
                                div {
                                    ...
                                    span { class: "text-sm font-medium text-muted-foreground", "Preview" }
                                ...
                                div {
                                    ...
                                    if let Some(ref img) = fetched_metadata.read().image {
                                        div {
                                            class: "w-32 h-24 rounded-lg overflow-hidden bg-muted shrink-0",
                                            img {
                                                src: "{img}",
                                                alt: "Preview",
                        ...
                        div {
                            ...
                            {
                                let display_image = custom_image_url.read().clone()
                                    .or_else(|| fetched_metadata.read().image.clone());
                                ...
                                rsx! {
                                    if let Some(ref img_url) = display_image {
                                        ...
                                        div {
                                            class: "relative w-full h-48 rounded-lg overflow-hidden mb-2 bg-muted",
                                            img {
                                                src: "{img_url}",
                                                alt: "Pin image",
                                                class: "w-full h-full object-cover"
                                            ...
                                            div {
                                                ...
                                                button {
                                                    ...
                                                    onclick: move |_| {
                                                        ...
                                                        // Also clear fetched image by resetting metadata
                                        ...
                                        // No image - show hint
                                        div {
                                            class: "p-4 border-2 border-dashed border-border rounded-lg text-center text-muted-foreground mb-2",
                            ...
                            MediaUploader {
                                ...
                                button_label: if custom_image_url.read().is_some() || fetched_metadata.read().image.is_some() {
                        ...
                        // Title (optional - may be auto-filled from fetch)
                        div {
                            label {
                                class: "block text-sm font-medium mb-2",
                                "Title "
                                if fetch_succeeded && fetched_metadata.read().title.is_some() {
                                    span { class: "text-muted-foreground font-normal", "(auto-filled)" }
                                } else {
                                    span { class: "text-muted-foreground font-normal", "(optional)" }
                                }
                            }
                        ...
                        div {
                            ...
                            if *boards_loading.read() {
                                ...
                                div {
                                    ...
                                    // Added other boards (collaborative)
                                    for (idx, board_addr) in other_boards.read().iter().enumerate() {
                                        {
                                            ...
                                            rsx! {
                                                div {
                                                    ...
                                                    // Checkmark icon
                                                    div {
                                                        class: "w-5 h-5 rounded bg-primary flex items-center justify-center shrink-0",
                                                        svg {
                                    ...
                                    // Create board link if no boards
