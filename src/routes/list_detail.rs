...
pub fn ListDetail(identifier: String) -> Element {
    ...
    // Find the list by identifier when lists load
    use_effect({
                ...
                // List not found
                    ...
                    div {
                        ...
                        button {
                            ...
                            onclick: move |_| { navigator.push("/lists"); },
                            "Back to Lists"
                        }
                    }
                }
                    ...
                    match l.kind {
                        ...
                        _ => rsx! {
                            div {
                                ...
                                "Unsupported list type (kind {l.kind})"
                            }
                        }
                    }
                }
    ...
    rsx! {
        div {
            ...
            div {
                ...
                // Avatar placeholder
                div {
                    class: "w-12 h-12 rounded-full bg-muted flex items-center justify-center text-xl",
                    "👤"
                }
...
fn RelayCard(url: String, read: bool, write: bool) -> Element {
    rsx! {
        div {
            class: "border border-border rounded-lg p-4 flex items-center gap-3",
            ...
            div {
                ...
                div {
                    ...
                    if read {
                        span {
                            class: "text-xs px-2 py-0.5 bg-green-500/10 text-green-600 rounded",
                            "Read"
                        }
                    }
                    if write {
                        span {
                            class: "text-xs px-2 py-0.5 bg-blue-500/10 text-blue-600 rounded",
                            "Write"
                        }
                    }
                }
    ...
    use_effect({
        ...
        move || {
            ...
            spawn(async move {
                ...
                // Collect event IDs from tags
                let mut event_ids: Vec<EventId> = Vec::new();

                // Get public event references
                for tag in list_event.tags.iter() {
    ...
    rsx! {
        div {
            ...
            div {
                ...
                span {
                    class: "text-xs px-2 py-0.5 bg-muted rounded text-muted-foreground",
                    "{kind_label}"
                }
                span {
