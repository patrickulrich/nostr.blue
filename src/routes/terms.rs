        ...
        div { class: "max-w-4xl mx-auto px-6 py-12",
            ...
            div { class: "prose dark:prose-invert max-w-none space-y-6",
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "1. Acceptance of Terms" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "2. Description of Service" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "3. User Responsibilities" }
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "4. Privacy and Data" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "5. Content and Conduct" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "6. Disclaimer of Warranties" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "7. Limitation of Liability" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "8. Changes to Terms" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "9. Contact" }
                    p {
