...
pub fn VoiceMessageNew() -> Element {
    ...
    let mut audio_data = use_signal(|| None::<(Vec<u8>, f64, Vec<u8>, String)>);
            ...
            div { class: "border-b border-border bg-background sticky top-0 z-10",
                div { class: "max-w-4xl mx-auto px-4 py-4 flex items-center justify-between",
                    div { class: "flex items-center gap-4",
                        ...
                        h1 { class: "text-2xl font-bold", "Record Voice Message" }
                    }
                    button {
            ...
            div { class: "max-w-4xl mx-auto px-4 py-8",
                ...
                div { class: "space-y-6",
                    div {
                        ...
                        VoiceRecorder { on_recording_complete: handle_recording_complete }
                        if audio_data.read().is_some() {
                            div { class: "mt-2 text-sm text-green-600", "✓ Recording ready" }
                        }
                    }
                    div {
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-2", "Upload to" }
                        select {
                            class: "w-full px-4 py-2 bg-background border border-border rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500",
                    ...
                    div { class: "p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg",
                        div { class: "text-sm text-blue-800 dark:text-blue-200",
                            p { class: "font-semibold mb-2", "Voice Message Guidelines:" }
