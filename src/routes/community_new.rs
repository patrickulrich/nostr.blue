        ...
        div {
            ...
            if !*nostr_client::CLIENT_INITIALIZED.read() {
                ...
                div {
                    class: "p-4",
                    div {
                        class: "p-4 bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 rounded-lg",
                    ...
                    form {
                        ...
                        div {
                            ...
                            button {
                                ...
                                disabled: *creating.read() || identifier.read().trim().is_empty() || name.read().trim().is_empty(),
                                if *creating.read() {
                                    span {
