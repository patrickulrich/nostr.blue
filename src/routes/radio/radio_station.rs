...
pub fn RadioStation(naddr: String) -> Element {
    ...
    // Fetch station data when client is initialized
            ...
            div {
                ...
                if *is_loading.read() {
                    ...
                    div {
                        ...
                        div {
                            class: "aspect-square max-w-sm mx-auto bg-muted rounded-xl"
                        }
                        div {
                            class: "space-y-3",
                    ...
                    div {
                        ...
                        div {
                            ...
                            img {
                                src: s.thumbnail.clone().unwrap_or_else(|| "https://api.dicebear.com/7.x/shapes/svg?seed=radio".to_string()),
                                alt: "{s.name}",
                            ...
                            if *is_playing.read() {
                                div {
                                    class: "absolute top-4 left-4 inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-red-500 text-white text-sm font-bold",
                                    span {
                        ...
                        div {
                            ...
                            if !s.genres.is_empty() {
                                div {
                                    class: "flex flex-wrap justify-center gap-2 mt-3",
                            ...
                            div {
                                ...
                                div {
                                    ...
                                    for (idx, stream) in s.streams.iter().enumerate() {
                                        button {
                                            key: "{idx}",
                                            class: if *selected_stream_idx.read() == idx {
                                                "flex items-center justify-between p-3 rounded-lg border-2 border-primary bg-primary/10"
                                            } else {
                                                "flex items-center justify-between p-3 rounded-lg border border-border hover:border-primary/50 transition"
                                            },
