            ...
            div {
                ...
                div { class: "p-4",
                    MentionAutocomplete {
                        ...
                        rows: 8,
                        class: "w-full min-h-[200px] p-3 bg-background border border-border rounded-lg resize-y focus:outline-hidden focus:ring-2 focus:ring-blue-500"
                            .to_string(),
                        disabled: false,
                    }
                    div { class: "mt-2 text-sm {counter_color} text-right",
