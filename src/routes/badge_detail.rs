...
pub fn BadgeDetail(naddr: String) -> Element {
        ...
        spawn(async move {
            ...
            match nip58::fetch_badge_definition(&addr).await {
                Ok(b) => {
                    ...
                    // Check if user has accepted this badge
    ...
    // Pre-compute values for rsx! (can't have let statements inside rsx! conditionals)
                ...
                div {
                    ...
                    div {
                        ...
                        div {
                            ...
                            if let Some(image) = b.get_image() {
                                ...
                                div {
                                    class: "w-48 h-48 rounded-xl bg-primary/20 flex items-center justify-center",
                                    span {
                    ...
                    div {
                        ...
                        div {
                            ...
                            Link {
                                to: Route::Profile { pubkey: b.pubkey.clone() },
                        ...
                        div {
                            ...
                            span {
                                "{format_relative_time(created_timestamp)}"
                            }
                        }
                    ...
                    if is_authenticated {
                        div {
                            ...
                            if *is_accepted.read() {
                                // Already accepted
                                div {
                                    class: "bg-green-500/10 border border-green-500/20 rounded-xl p-4 text-center",
                                ...
                                div {
                                    ...
                                    button {
                                        ...
                                        onclick: move |_| {
                                            // Just dismiss - don't do anything
                                ...
                                // No pending award
                                div {
                                    class: "bg-muted rounded-xl p-4 text-center",
                    ...
                    div {
                        ...
                        button {
                            ...
                            onclick: {
                                ...
                                move |_| {
                                    // Copy nostr:naddr1... URI to clipboard (NIP-21)
