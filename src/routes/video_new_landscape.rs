    ...
    rsx! {
        div { class: "min-h-screen bg-background",
            div { class: "border-b border-border bg-background sticky top-0 z-10",
                div { class: "max-w-4xl mx-auto px-4 py-4 flex items-center justify-between",
                    div { class: "flex items-center gap-4",
                        ...
                        h1 { class: "text-2xl font-bold", "Upload Video" }
                    }
                    button {
            ...
            div { class: "max-w-4xl mx-auto px-4 py-8",
                ...
                div { class: "space-y-6",
                    div {
                        label { class: "block text-sm font-medium mb-2", "Video * (Landscape/Horizontal)" }
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-2", "Thumbnail (optional)" }
                        if !thumbnail_url.read().is_empty() {
                            div { class: "mb-4",
                                img {
                                    src: "{thumbnail_url}",
                                    class: "w-full max-w-md aspect-video object-cover rounded-lg border border-border",
                                }
                                button {
                                    class: "mt-2 text-sm text-red-500 hover:text-red-600",
                                    onclick: move |_| {
                    ...
                    div {
                        ...
                        input {
                            r#type: "text",
                            class: "w-full px-4 py-2 bg-background border border-border rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500",
                            placeholder: "video, tutorial, nostr (comma separated)",
                            value: "{hashtags}",
