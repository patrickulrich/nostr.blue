    ...
    rsx! {
        div { class: "max-w-4xl mx-auto px-6 py-12",
            ...
            div { class: "prose dark:prose-invert max-w-none space-y-6",
                p { class: "text-lg text-muted-foreground", "Last updated: October 29, 2025" }
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "2. Data We Don't Collect" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "3. Local Data Storage" }
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "4. Public Data on Nostr" }
                    p { "When you publish content through nostr.blue:" }
                    ul { class: "list-disc pl-6 space-y-2",
                        li {
                            "Posts, reactions, and public interactions are broadcast to Nostr relay servers"
                        }
                    ...
                    p { "Remember: Anything you post publicly on Nostr is permanent and decentralized." }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "5. Third-Party Services" }
                    p { "nostr.blue connects to:" }
                    ul { class: "list-disc pl-6 space-y-2",
                        li {
                            strong { "Nostr Relays: " }
                            "Independent servers that relay Nostr events"
                        }
                        li {
                            strong { "Lightning Network Services: " }
                            "For zap payments (if you use this feature)"
                        }
                        li {
                            strong { "Media Hosting: " }
                            "When you view images/videos from external URLs"
                        }
                    }
                    p { "These services have their own privacy policies. We recommend reviewing them." }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "6. Cookies and Tracking" }
                    p {
                ...
                section { class: "space-y-4",
                    ...
                    p { "However, you are responsible for keeping your private keys secure." }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "8. Your Rights" }
                    ...
                    ul { class: "list-disc pl-6 space-y-2",
                        ...
                        li {
                            "Request deletion from specific relays (though we cannot guarantee removal)"
                        }
                    }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "9. Children's Privacy" }
                    p {
                        "nostr.blue is not intended for users under 13 years of age. We do not knowingly collect information from children."
                    }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "10. Changes to Privacy Policy" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "11. Contact" }
                    p {
