                    ...
                    form {
                        ...
                        div {
                            ...
                            if let Some(ref url) = *image_url.read() {
                                div {
                                    class: "relative w-full h-40 rounded-lg overflow-hidden mb-2",
                                    img {
                                        src: "{url}",
                                        alt: "Cover image",
    ...
    rsx! {
        div {
            ...
            if !*nostr_client::CLIENT_INITIALIZED.read() {
                ...
                div {
                    class: "p-4 max-w-2xl mx-auto animate-pulse space-y-6",
