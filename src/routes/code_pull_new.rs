            ...
            div {
                    ...
                    div {
                        ...
                        div {
                            p {
                                ...
                                span { class: "text-muted-foreground", " - Your pull request will be published as a Kind 1617 event on Nostr. Include your patch content or a cover letter describing your changes." }
                            }
                        }
                    }
                }
                ...
                div {
                    ...
                    div {
                        class: "flex gap-3",
                        button {
                            class: if *is_cover_letter.read() {
                                "flex-1 p-3 rounded-lg border-2 border-primary bg-primary/10 text-sm text-left"
                            } else {
                                "flex-1 p-3 rounded-lg border border-border bg-muted text-sm text-left hover:bg-accent transition"
                            },
                ...
                div {
                    label {
                        class: "block text-sm font-medium mb-2",
                        if *is_cover_letter.read() { "Cover Letter " } else { "Patch Content " }
