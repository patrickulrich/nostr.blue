            ...
            div {
                ...
                div {
                    ...
                    div {
                        ...
                        button {
                            class: if *active_tab.read() == UserPinsTab::Pins {
                            ...
                            "Pins"
                            span {
                                class: "ml-2 px-2 py-0.5 text-xs rounded-full bg-muted",
                                "{pins_count}"
                            }
                        }
                        button {
                            class: if *active_tab.read() == UserPinsTab::Boards {
                                "px-4 py-2 text-sm font-medium text-foreground border-b-2 border-primary -mb-px"
                            } else {
                                "px-4 py-2 text-sm font-medium text-muted-foreground hover:text-foreground"
                            },
