...
pub fn Cookies() -> Element {
    rsx! {
        div { class: "max-w-4xl mx-auto px-6 py-12",
            h1 { class: "text-4xl font-bold mb-8", "Cookie Policy" }
            div { class: "prose dark:prose-invert max-w-none space-y-6",
                p { class: "text-lg text-muted-foreground", "Last updated: October 29, 2025" }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "1. What Are Cookies?" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "2. How nostr.blue Uses Cookies" }
                    p {
                ...
                section { class: "space-y-4",
                    ...
                    div { class: "space-y-4 mt-4",
                        div { class: "border border-border rounded-lg p-4",
                            h3 { class: "font-semibold mb-2", "Authentication" }
                            ...
                            p { class: "text-xs",
                                strong { "Duration: " }
                                "Until you log out or clear browser data"
                            }
                        }
                        div { class: "border border-border rounded-lg p-4",
                            h3 { class: "font-semibold mb-2", "User Preferences" }
                            p { class: "text-sm text-muted-foreground",
                        ...
                        div { class: "border border-border rounded-lg p-4",
                            h3 { class: "font-semibold mb-2", "Performance Cache" }
                            p { class: "text-sm text-muted-foreground",
                            ...
                            p { class: "text-xs",
                                strong { "Duration: " }
                                "Varies, automatically cleared when old"
                            }
                        }
                    }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "4. No Third-Party Cookies" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "5. Managing Cookies and Local Storage" }
                    p {
                    ...
                    p { class: "mt-4",
                        strong { "Note: " }
                        "Clearing local storage will log you out and reset your preferences."
                    }
                }
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "6. Browser Extensions" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "7. Changes to Cookie Policy" }
                    p {
                ...
                section { class: "space-y-4",
                    h2 { class: "text-2xl font-semibold mt-8", "8. Contact" }
                    p {
