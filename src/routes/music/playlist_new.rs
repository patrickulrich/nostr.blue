    ...
    rsx! {
        div { class: "max-w-2xl mx-auto p-6",
            div { class: "flex items-center gap-4 mb-8",
                ...
                h1 { class: "text-2xl font-bold", "Create Playlist" }
            }
            div { class: "space-y-6",
                ...
                div { class: "space-y-3",
                    h3 { class: "text-sm font-medium", "Visibility" }
                    div { class: "flex items-center gap-3",
                        ...
                        label { r#for: "is-public", class: "text-sm", "Public playlist" }
                    }
                    div { class: "flex items-center gap-3",
                        input {
                            r#type: "checkbox",
                        ...
                        label { r#for: "is-collaborative", class: "text-sm",
