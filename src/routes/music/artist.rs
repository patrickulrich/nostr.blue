...
pub fn MusicArtist(artist_id: String) -> Element {
    ...
    if is_nostr_artist {
        rsx! {
            NostrArtistSection { pubkey: artist_id }
        }
    } else {
        rsx! {
            WavlakeArtistSection { artist_id }
        }
    }
}
                                    ...
                                    div {
                                        ...
                                        div { class: "p-4 space-y-3",
                                            ...
                                            Link {
                                                ...
                                                class: "block w-full",
                                                button { class: "w-full px-4 py-2 rounded border border-gray-600 hover:border-purple-500 text-sm text-gray-300 hover:text-white transition-colors inline-flex items-center justify-center gap-2",
