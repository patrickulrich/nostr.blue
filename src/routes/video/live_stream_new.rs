        ...
        div { class: "min-h-screen bg-background",
            div { class: "border-b border-border bg-background sticky top-0 z-10",
                div { class: "max-w-4xl mx-auto px-4 py-4 flex items-center justify-between",
                    div { class: "flex items-center gap-4",
                        ...
                        h1 { class: "text-2xl font-bold", "Create Live Stream" }
                    }
                    button {
            ...
            div { class: "max-w-4xl mx-auto px-4 py-8",
                ...
                div { class: "space-y-6",
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-2", "Stream URL (HLS/RTMP) *" }
                        input {
                            r#type: "url",
                    ...
                    div {
                        label { class: "block text-sm font-medium mb-2", "Thumbnail Image URL" }
                        input {
                            r#type: "url",
                            class: "w-full px-4 py-2 bg-input border border-border rounded-lg focus:outline-hidden focus:ring-2 focus:ring-blue-500",
                    ...
                    div {
                        ...
                        select {
                            ...
                            option { value: "planned", "Planned (Upcoming)" }
                            option { value: "live", "Live (Start streaming now)" }
                        }
                        p { class: "mt-1 text-xs text-muted-foreground",
                            if *status.read() == "live" {
