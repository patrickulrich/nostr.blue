...
{:else}
  ...
  {#if isOpen}
    ...
    >
      <div
        class="fixed bottom-0 left-0 right-0 max-h-[85vh] overflow-y-auto bg-background rounded-t-2xl shadow-lg"
        onclick={(e) => e.stopPropagation()}
        onkeydown={(e) => e.stopPropagation()}
        role="dialog"
        tabindex="-1"
      >
        ...
        <div class="pt-4 pb-2 flex justify-center">
          <div class="w-12 h-1 rounded-full bg-muted"></div>
        </div>
        ...
        <div class="p-6 space-y-4">
          ...
          <!-- Wallet Status (reusing desktop content) -->
          <div class="space-y-3">
            <h3 class="font-medium">Current Status</h3>
            <div class="grid gap-3">
              <!-- WebLN Status -->
  ...
  {#if addDialogOpen}
    ...
    >
      <div
        class="fixed bottom-0 left-0 right-0 max-h-[85vh] overflow-y-auto bg-background rounded-t-2xl shadow-lg p-6"
        onclick={(e) => e.stopPropagation()}
        onkeydown={(e) => e.stopPropagation()}
        role="dialog"
        tabindex="-1"
      >
        ...
        <div class="space-y-4">
          <div>
            <label for="alias-mobile" class="block text-sm font-medium mb-1">
              Wallet Name (optional)
            </label>
            <input
              id="alias-mobile"
          ...
          <div>
            <label for="connection-uri-mobile" class="block text-sm font-medium mb-1">
              Connection URI
            </label>
            <textarea
              id="connection-uri-mobile"
              placeholder="nostr+walletconnect://..."
              bind:value={connectionUri}
              rows="3"
              class="w-full px-3 py-2 border rounded-md bg-background resize-none"
